import { deepMerge, INDIC_PATCHES } from "./woolcraft-indic-locales.js";
...
const localeEn = {
		...
		footerColOrder: "Order",
		footerColContact: "Contact",
		footerTagline: "Handcrafted wool art from Kota, Rajasthan",
		footerBio:
		...
		footerWa: "Order on WhatsApp",
		footerLinkPlaceOrder: "Place an Order",
		footerLinkCustom: "Custom Request",
		footerLinkShipping: "Shipping Info",
		footerLinkBulk: "Shaadi / Bulk",
		footerLinkPay: "Payments / UPI",
		footerLocation: "Kota, Rajasthan 302001",
		footerHours: "Mon–Sat · 10am–7pm",
		footerWaHint: "WhatsApp preferred",
		browseProductsCta: "Browse Products",
		footerRights: "All rights reserved.",
		footerMadeIn: "Made with 🧶 & ❤️ in Bharat 🇮🇳",
};
...
const localeHi = {
		...
		footerTagline: "कोटा, राजस्थान से हस्तनिर्मित ऊन कला",
		footerBio:
			"हस्तनिर्मित ऊनी कला — फूल, पत्तियाँ, डिब्बे और भी — कोटा में प्यार से बनाई। हर कृति एक कहानी।",
		footerWa: "WhatsApp पर ऑर्डर",
		footerLinkPlaceOrder: "ऑर्डर करें",
		footerLinkCustom: "कस्टम ऑर्डर",
		footerLinkShipping: "शिपिंग जानकारी",
		footerLinkBulk: "शादी / बल्क",
		footerLinkPay: "UPI भुगतान",
		footerLocation: "कोटा, राजस्थान 324008",
		footerHours: "सोम–शनि · 10–7 बजे",
		footerWaHint: "WhatsApp पसंदीदा",
		browseProductsCta: "उत्पाद देखें",
		footerRights: "सर्वाधिकार सुरक्षित।",
		footerMadeIn: "🇮🇳 भारत में 🧶 और ❤️ से बनाया गया",
};

export const SUPPORTED_LANGS = ["en", "hi", "pa", "gu", "mr", "te", "bn"];
...
export const T = {
	en: localeEn,
	hi: localeHi,
	pa: deepMerge(localeEn, INDIC_PATCHES.pa),
	gu: deepMerge(localeEn, INDIC_PATCHES.gu),
	mr: deepMerge(localeEn, INDIC_PATCHES.mr),
	te: deepMerge(localeEn, INDIC_PATCHES.te),
	bn: deepMerge(localeEn, INDIC_PATCHES.bn),
};
...
export function getSiteUrl() {
	...
	return "https://wool-craft.vercel.app";
}
