/**
 * WoolCraft — Nonprofit / Charity CRM — Master Data File
 *
...
const DONORS = [
	{
		...
		staff: "AM",
		email: "ellison@family.org",
		phone: "+1 (415) 555-0112",
		notes: "Multi-year major donor. Interested in education programs.",
		tags: ["Recurring", "Board-Connected", "Education"],
	},
	{
		id: 2,
		...
		source: "Grant Portal",
		staff: "JT",
		email: "grants@sunrise.org",
		phone: "+1 (212) 555-0234",
		notes: "Prefers program-specific grants. Annual cycle due April.",
		tags: ["Multi-year", "Grant", "April Deadline"],
	},
	{
		id: 3,
		name: "Marcus & Ruth Chen",
		type: "Individual",
		tier: "Mid-Level",
		stage: "Solicitation",
		ltv: 18500,
		...
		notes: "Met at annual gala. Open to naming opportunity.",
		tags: ["Event-Connected"],
	},
	{
		id: 4,
		...
		staff: "RK",
		email: "csr@northgate.bank",
		phone: "+1 (713) 555-0456",
		notes: "CSR budget renewed annually in February.",
	...
	},
	{
		...
		source: "RFP Response",
		staff: "JT",
		email: "grants@springfield.gov",
		phone: "+1 (217) 555-0567",
		notes: "CDBG funding. Reporting due June 30.",
		tags: ["Government", "Reporting-Due"],
	},
	{
		id: 6,
		name: "Patricia Osei-Mensah",
		type: "Individual",
		tier: "General",
		stage: "Prospect",
		ltv: 0,
		...
		notes: "Downloaded impact report. Sent welcome email.",
		tags: ["New", "Digital"],
	},
	{
		id: 7,
		name: "Meridian Tech Corp",
		type: "Corporate",
		tier: "Major",
		stage: "Cultivation",
		ltv: 55000,
		...
		source: "Board Referral",
		staff: "AM",
		email: "giving@meridian.com",
		phone: "+1 (206) 555-0789",
		notes: "CEO is board member's colleague. First meeting scheduled.",
		tags: ["High-Potential", "Tech"],
	},
	{
		id: 8,
		name: "James & Anita Holbrook",
		type: "Individual",
		tier: "Mid-Level",
		stage: "Lapsed",
		ltv: 22000,
		...
		source: "Direct Mail",
		staff: "NP",
		email: "jholbrook@email.com",
		phone: "+1 (602) 555-0890",
		notes: "No contact in 7 months. Re-engagement sequence started.",
...
const GRANTS = [
	{
		...
		reportDue: "Dec 31",
		submitted: "Mar 1",
		notes: "LOI approved. Full proposal due April 15.",
	},
	{
		id: 2,
		funder: "City of Springfield",
		amount: 60000,
		deadline: "Awarded",
		stage: "Awarded",
		program: "Housing",
		...
		reportDue: "Jun 30",
		submitted: "Jan 10",
		notes: "CDBG grant awarded. Mid-year report due June 30.",
	},
	{
		id: 3,
		funder: "W.K. Kellogg Found.",
		amount: 120000,
		deadline: "May 1",
		stage: "LOI Submitted",
		program: "Youth Dev.",
		...
		reportDue: "—",
		submitted: "Feb 28",
		notes: "LOI submitted. Decision expected April 1.",
	},
	{
		id: 4,
		...
		reportDue: "—",
		submitted: "—",
		notes: "Identified as strong fit. Research phase.",
	},
	{
		id: 5,
		funder: "Local Community Found.",
		amount: 25000,
		deadline: "Mar 28",
		stage: "Under Review",
		program: "Arts",
		...
		reportDue: "—",
		submitted: "Feb 15",
		notes: "Application submitted. Site visit scheduled.",
	},
	{
		id: 6,
		funder: "Tech for Good",
		amount: 30000,
		deadline: "Closed",
		stage: "Rejected",
		program: "Technology",
		...
		reportDue: "—",
		submitted: "Oct 5",
		notes: "Declined — out of geographic scope.",
	},
];
...
const VOLUNTEERS = [
	{
		...
		skills: ["Fundraising", "Communications"],
		hours: 142,
...
const TASKS_DATA = [
	{
		id: 1,
		text: "Call Ellison Family — Q1 stewardship update",
		due: "Today",
		staff: "AM",
		priority: "high",
		done: false,
	...
	{
		id: 2,
		text: "Finish Sunrise Foundation full proposal draft",
		due: "Today",
		staff: "JT",
		priority: "high",
		done: false,
	...
	{
		id: 3,
		text: "Send Spring Gala save-the-date to donor list",
		due: "Tomorrow",
		staff: "RK",
		priority: "medium",
		done: false,
	...
	{
		id: 4,
		text: "Re-engagement email — James & Anita Holbrook",
		due: "Tomorrow",
		staff: "NP",
		priority: "medium",
		done: false,
	...
	{
		id: 5,
		text: "Submit Local Community Foundation application",
		due: "Mar 28",
		staff: "RK",
		priority: "high",
		done: false,
	...
	{
		id: 6,
		text: "Prepare Q1 board report — financials",
		due: "Mar 18",
		staff: "AM",
		priority: "medium",
		done: true,
	...
	{
		id: 7,
		text: "Confirm catering for Volunteer Appreciation Day",
		due: "Mar 15",
		staff: "LW",
		priority: "low",
		done: false,
	...
	{
		id: 8,
		text: "Update Capital Campaign donor wall list",
		due: "Mar 20",
		staff: "NP",
		priority: "low",
		done: false,
...
const EMAIL_TEMPLATES = [
	...
	{
		id: 2,
		name: "Gift Acknowledgement",
		category: "Thank You",
		opens: 96,
		sent: 680,
		subject: "Thank you for your generous gift, {name}",
	},
	{
		id: 3,
		...
		opens: 64,
		sent: 1240,
		subject: "{name}, your support changes everything",
	},
	{
		id: 4,
	...
	},
	{
		...
		opens: 84,
		sent: 540,
		subject: "See what your gift accomplished this year",
	},
	{
		id: 7,
		...
		opens: 91,
		sent: 86,
		subject: "Confirming receipt of your grant — {org}",
	},
];
...
const SEQUENCES = [
	{
		id: 1,
		name: "New Donor Welcome Series",
		status: "Active",
		contacts: 48,
		emails: 5,
		openRate: 82,
		nextStep: "Day 7 — impact story",
	},
	{
		id: 2,
...
const raisedOverTime = [
	{ month: "Sep", raised: 48, donors: 38 },
	{ month: "Oct", raised: 62, donors: 51 },
	{ month: "Nov", raised: 58, donors: 44 },
	{ month: "Dec", raised: 142, donors: 189 },
	{ month: "Jan", raised: 54, donors: 42 },
	{ month: "Feb", raised: 71, donors: 58 },
...
const STAFF_LIST = [
	...
	},
	{
		...
		email: "jamie@hope.org",
	},
	{
		code: "RK",
		name: "Rachel Kim",
		role: "Program Manager",
		email: "rachel@hope.org",
	},
	{
		code: "NP",
		name: "Nina Patel",
...
const UPCOMING_DEADLINES = [
	...
	{
		label: "W.K. Kellogg LOI",
		date: "Apr 1",
		type: "Grant",
		colorKey: "purple",
	},
	{
		label: "Local Comm. Found.",
		date: "Mar 28",
		type: "Grant",
		colorKey: "amber",
	},
	{
		label: "Board Meeting Q1",
		date: "Mar 18",
		type: "Event",
		colorKey: "blue",
	},
...
const NOTIFICATIONS = [
	{
		text: "Sunrise Foundation proposal due in 4 days",
		time: "Now",
		dotKey: "red",
	},
