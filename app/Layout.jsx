...
function ProgressBar({ value, max, color, t, height = 7 }) {
...
export default function Layout({ children }) {
	...
	const activePage = (
		path.split("?")[0].replace(/^\//, "") || "dashboard"
	).trim();
			...
			>
							...
							{NAV.map((item) => (
								<div
									...
									style={{
										...
										padding:
											sidebarCollapsed && !isMobile ? "11px" : "10px 14px",
									}}
								>
									<span
										style={{
						...
						<div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
							{THEME_OPTIONS.map((opt) => (
								<button
									...
									style={{
										flex:
											"1 1 " + (sidebarCollapsed && !isMobile ? "0" : "45%"),
				...
				>
					...
					>
						...
						>
							<span
								style={{ fontSize: 12, color: t.textMuted, fontWeight: 600 }}
							>
								WoolCraft
							</span>
